...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">Junk Removal </span>
          </h2>
            <span className="text-orange-500"> Clear Out, Stress Out</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
          Clutter doesn’t have to control your space. Reloq8U offers quick and reliable junk removal services for homes, offices, and commercial properties. From old furniture and appliances to renovation debris and general waste, we handle it all.

          </p>
          <p className='text-gray-800 leading-relaxed'>
            Our team works efficiently to give you a cleaner, clutter-free environment—so you can enjoy more space without the hassle.
          </p>
