...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">International Moving </span>
          </h2>
            <span className="text-orange-500"> Your Global Relocation Partner</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
             Moving abroad is a big step, and Reloq8U makes it easier. Our international moving services are designed to simplify every stage of your relocation—from packing and logistics to customs clearance and delivery.

          </p>
          <p className='text-gray-800 leading-relaxed' >
            With our expertise in handling overseas moves, you can focus on your new beginning while we ensure your belongings arrive securely and on time. Wherever life takes you, Reloq8U is your trusted partner across borders.
          </p>
