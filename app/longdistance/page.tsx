...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">Long-Distance Moving </span>
          </h2>
            <span className="text-orange-500"> Across Provinces, Across Canada
</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
          Relocating to another city or province doesn’t need to be stressful. At Reloq8U, our long-distance moving services combine expert planning, secure transport, and reliable communication to make the journey effortless.

          </p>
      <p className=' text-gray-800 leading-relaxed'>
            We provide real-time updates, flexible scheduling, and personalized moving plans to fit your budget and timeline. No matter the distance, we make sure your move is safe, efficient, and worry-free.
