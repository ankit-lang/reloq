...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">Single-Item Moving </span>
          </h2>
            <span className="text-orange-500"> Extra Care for What Matters Most</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
          Not every move involves a whole house. Sometimes, it’s just one special item that needs expert handling. At Reloq8U, we specialize in moving high-value and delicate belongings such as pianos, fine art, antiques, and specialty furniture.

          </p>
          <p className='text-gray-800 leading-relaxed'>
            Using advanced packing techniques, careful planning, and optional insurance coverage, we treat every item with the highest level of care—so you can have complete peace of mind.
