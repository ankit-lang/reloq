...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">RESIDENTIAL MOVING</span>
          </h2>
            <span className="text-orange-500">Your Home, Moved with Care</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
           Moving homes is more than just transporting boxes—it’s about safely relocating your life and memories. At Reloq8U, we specialize in stress-free household moves, combining experience, professionalism, and care to make your transition seamless.
From cozy apartments and family homes to large estates, our residential movers are trained to handle every detail. Whether it’s navigating narrow staircases, dismantling furniture, or safeguarding delicate items, we’re equipped to ensure your belongings reach their new destination safely.
