...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">Last-Minute Moving</span>
          </h2>
            <span className="text-orange-500"> Fast, Flexible, Stress-Free</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
           Need to move urgently? Reloq8U has you covered. Our last-minute moving services are designed for speed without compromising on safety. Whether it’s local or long-distance, our licensed and insured movers can quickly organize packing, loading, transport, and storage. With flexible scheduling and a team trained to handle high-pressure moves, we turn last-minute relocations into stress-free experiences. No matter the deadline, Reloq8U gets you moving—fast.
          </p>
