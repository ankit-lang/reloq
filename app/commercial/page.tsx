...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">Commercial Moving </span>
          </h2>
            <span className="text-orange-500">Business Relocations Made Simple</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
          At Reloq8U, we understand that every hour counts when it comes to moving your business. Our commercial moving services are designed to keep your operations running smoothly while we handle the logistics. From office relocations to industrial moves and storage solutions, our expert movers plan every step with precision and efficiency.
          </p>

          <p className="mt-4 text-gray-800 leading-relaxed">
           With advanced equipment, tailored moving strategies, and a focus on minimizing downtime, Reloq8U ensures your business transitions seamlessly to its new location.
          </p>
        </div>
</AnimatedContent>
