...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">Condominium Moving </span>
          </h2>
            <span className="text-orange-500"> Smart Solutions for Compact Spaces
</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
         Condo moves come with unique challenges—tight hallways, elevators, and building rules. But with Reloq8U, that’s never a problem. Our experienced movers know how to navigate these obstacles with efficiency and care. From packing and storage to loading and unloading, we ensure a smooth relocation tailored to your building’s requirements. Whether you’re moving into or out of a condominium, trust Reloq8U to handle the details so you can enjoy a stress-free move.
