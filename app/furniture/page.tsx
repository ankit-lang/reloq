...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">Furniture Moving </span>
          </h2>
            <span className="text-orange-500">Strength Meets Care
</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
           Moving large, heavy, or oddly-shaped furniture doesn’t have to be stressful. At Reloq8U, we specialize in safe and efficient furniture relocations. Our team uses advanced equipment and proven techniques to handle everything—from delicate antiques and custom-built pieces to bulky sofas and entertainment systems. With careful packing, secure loading, and smooth delivery, we ensure your furniture arrives at its new home in perfect condition.
