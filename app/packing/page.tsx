...
>
        ...
        <div className="flex flex-col md:mt-20 text-justify text-black justify-center">
          <h2 className="text-3xl  md:text-4xl font-bold">
            <span className=" ">Packing Services</span>
          </h2>
            <span className="text-orange-500"> Secure & Customized for You</span>

          <p className="mt-6 text-gray-800 leading-relaxed">
          Packing is the foundation of a successful move, and at Reloq8U, we do it right. Our expert packing team uses high-quality materials and specialized techniques to protect your belongings, from fragile glassware to heavy furniture. We offer full-service packing, partial assistance, or custom plans designed around your needs. With detailed organization, safe loading, and careful unpacking, our packing solutions take the hassle out of moving—giving you confidence every step of the way.
